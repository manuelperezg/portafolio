...
module.exports = "<div class=\"header-intro theme-bg-primary text-white py-5\">\n\t<div class=\"container\">\n\t\t<div class=\"profile-teaser media flex-column flex-md-row\">\n\t\t\t<img class=\"profile-image mb-3 mb-md-0 mr-md-5 ml-md-0 rounded mx-auto\" src=\"assets/images/profile.jpg\"\n\t\t\t\talt=\"\">\n\t\t\t<div class=\"media-body text-center text-md-left\">\n\t\t\t\t<div class=\"lead\">Hola, mi nombre es </div>\n\t\t\t\t<h2 class=\"mt-0 display-4 font-weight-bold\">José Manuel Pérez</h2>\n\t\t\t\t<div class=\"bio mb-3\">Soy un desarrollador full-stack especializado en desarrollo frontend y backend\n\t\t\t\t\tpara aplicaciones web escalables desde básicas hasta complejas.\n\n\t\t\t\t\t¿Quieres saber cómo puedo ayudarte en tu proyecto? Mira mis <a class=\"link-on-bg\"\n\t\t\t\t\t\thref=\"projects.html\"> proyectos </a> y/o <a class=\"link-on-bg\" href=\"resume.html\">resumen.</a>\n\t\t\t\t</div>\n\t\t\t\t<!--//bio-->\n\t\t\t\t<a class=\"theme-btn-on-bg btn font-weight-bold theme-btn-cta\" [routerLink]=\"['/contacto']\">CONTACTO</a>\n\n\t\t\t</div>\n\t\t\t<!--//media-body-->\n\t\t</div>\n\t\t<!--//profile-teaser-->\n\n\t</div>\n\t<!--//container-->\n</div>\n<!--//header-intro-->\n\n<section class=\"skills-section section py-5\">\n\t<div class=\"container\">\n\t\t<h3 class=\"section-title font-weight-bold text-center mb-3\">Resumen de habilidades</h3>\n\t\t<div class=\"section-intro mx-auto text-center mb-5 text-secondary\">Tengo más de 6 años de experiencia en la\n\t\t\tcreación de aplicaciones web para clientes de todo el mundo. A continuación, se incluye un resumen rápido de\n\t\t\tmis principales habilidades técnicas y herramientas que uso. ¿Quieres saber más sobre mi experiencia? <a\n\t\t\t\t[routerLink]=\"['/resumen']\">Consulta mi resumen</a>.</div>\n\n\t\t<div class=\"skills-blocks mx-auto pt-5\">\n\t\t\t<div class=\"row\">\n\t\t\t\t<div class=\"skills-block col-12 col-lg-4 mb-5 mb-3 mb-lg-0\">\n\t\t\t\t\t<div class=\"skills-block-inner bg-white shadow-sm py-4 px-5 position-relative\">\n\t\t\t\t\t\t<h4 class=\"skills-cat text-center mb-3 mt-5\">Frontend</h4>\n\t\t\t\t\t\t<div class=\"skills-icon-holder position-absolute d-inline-block rounded-circle text-center\">\n\t\t\t\t\t\t\t<img class=\"skills-icon\" src=\"assets/images/frontend-icon.svg\">\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<ul class=\"skills-list list-unstyled text-secondary\">\n\t\t\t\t\t\t\t<li class=\"mb-2\"><i class=\"fas fa-check mr-2 text-primary\"></i>VueJS / Angular / React\n\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t<li class=\"mb-2\"><i class=\"fas fa-check mr-2 text-primary\"></i>Javascript / ECM6 </li>\n\t\t\t\t\t\t\t<li class=\"mb-2\"><i class=\"fas fa-check mr-2 text-primary\"></i>Bootstrap / Vuetify /\n\t\t\t\t\t\t\t\tMaterialize</li>\n\t\t\t\t\t\t\t<li class=\"mb-2\"><i class=\"fas fa-check mr-2 text-primary\"></i>HTML5 / CSS3 / SASS</li>\n\t\t\t\t\t\t</ul>\n\t\t\t\t\t</div>\n\t\t\t\t\t<!--//skills-block-inner-->\n\t\t\t\t</div>\n\t\t\t\t<!--//skills-block-->\n\n\t\t\t\t<div class=\"skills-block col-12 col-lg-4 mb-5 mb-3 mb-lg-0\">\n\t\t\t\t\t<div class=\"skills-block-inner bg-white shadow-sm py-4 px-5 position-relative\">\n\t\t\t\t\t\t<h4 class=\"skills-cat text-center mb-3 mt-5\">Backend</h4>\n\t\t\t\t\t\t<div class=\"skills-icon-holder position-absolute d-inline-block rounded-circle text-center\">\n\t\t\t\t\t\t\t<img class=\"skills-icon\" src=\"assets/images/backend-icon.svg\">\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<ul class=\"skills-list list-unstyled text-secondary\">\n\t\t\t\t\t\t\t<li class=\"mb-2\"><i class=\"fas fa-check mr-2 text-primary\"></i>NodeJS / Express</li>\n\t\t\t\t\t\t\t<li class=\"mb-2\"><i class=\"fas fa-check mr-2 text-primary\"></i>PHP / Laravel / Slim</li>\n\t\t\t\t\t\t\t<li class=\"mb-2\"><i class=\"fas fa-check mr-2 text-primary\"></i> MySQL / Oracle / SQL Server\n\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t<li class=\"mb-2\"><i class=\"fas fa-check mr-2 text-primary\"></i>FireBase, MongoDB</li>\n\t\t\t\t\t\t</ul>\n\t\t\t\t\t</div>\n\t\t\t\t\t<!--//skills-block-inner-->\n\t\t\t\t</div>\n\t\t\t\t<!--//skills-block-->\n\n\t\t\t\t<div class=\"skills-block col-12 col-lg-4\">\n\t\t\t\t\t<div class=\"skills-block-inner bg-white shadow-sm py-4 px-5 position-relative\">\n\t\t\t\t\t\t<h4 class=\"skills-cat text-center mb-3 mt-5\">Otras</h4>\n\t\t\t\t\t\t<div class=\"skills-icon-holder position-absolute d-inline-block rounded-circle text-center\">\n\t\t\t\t\t\t\t<img class=\"skills-icon\" src=\"assets/images/other-skills-icon.svg\">\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<ul class=\"skills-list list-unstyled text-secondary\">\n\t\t\t\t\t\t\t<li class=\"mb-2\"><i class=\"fas fa-check mr-2 text-primary\"></i> APIS REST</li>\n\t\t\t\t\t\t\t<li class=\"mb-2\"><i class=\"fas fa-check mr-2 text-primary\"></i>AWS, Lambda,EC2..etc </li>\n\t\t\t\t\t\t\t<li class=\"mb-2\"><i class=\"fas fa-check mr-2 text-primary\"></i>Web Services (SOAP)</li>\n\n\t\t\t\t\t\t\t<li class=\"mb-2\"><i class=\"fas fa-check mr-2 text-primary\"></i> Git y Github</li>\n\n\t\t\t\t\t\t</ul>\n\t\t\t\t\t</div>\n\t\t\t\t\t<!--//skills-block-inner-->\n\t\t\t\t</div>\n\t\t\t\t<!--//skills-block-->\n\n\t\t\t</div>\n\t\t\t<!--//row-->\n\t\t</div>\n\t</div>\n\t<!--//container-->\n</section>\n<!--//skills-section-->\n\n<section class=\"section-featured-projects py-5\">\n\t<div class=\"container\">\n\t\t<h3 class=\"section-title font-weight-bold text-center mb-5\">Proyectos Destacados</h3>\n\t\t<div class=\"project-cards row mb-5\">\n\t\t\t<div class=\"col-12 col-lg-4 mt-4\">\n\t\t\t\t<div class=\"card rounded-0 border-0 shadow-sm mb-5 mb-lg-0\">\n\t\t\t\t\t<div class=\"card-img-container position-relative\">\n\t\t\t\t\t\t<img class=\"card-img-top rounded-0 h-90\" src=\"assets/images/projects/viva_fan.png\"\n\t\t\t\t\t\t\talt=\"Viva Contigo\">\n\t\t\t\t\t\t<div class=\"card-img-overlay overlay-logo text-center\">\n\t\t\t\t\t\t\t<div class=\"project-logo\"><img class=\"img-fluid\" style=\"width: 90px;\"\n\t\t\t\t\t\t\t\t\tsrc=\"assets/images/logos/logo_vivafan.svg\"></div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<a class=\"card-img-overlay overlay-content text-left p-lg-4\"\n\t\t\t\t\t\t\t[href]=\"['https://www.vivaaerobus.com/es-mx/membresia/vivafan']\"\n\t\t\t\t\t\t\ttarget=\"_blank\">\n\t\t\t\t\t\t\t<p class=\"card-title font-weight-bold\"> Viva Fan </p>\n\t\t\t\t\t\t\t<p>\n\t\t\t\t\t\t\t\tLa membresía para el viajero inteligente.\n\t\t\t\t\t\t\t\tTarifas bajas y equipaje extra, ¡así es ser Viva Fan!\n\t\t\t\t\t\t\t</p>\n\n\t\t\t\t\t\t</a>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"card-body pb-0\">\n\t\t\t\t\t\t<h4 class=\"card-title text-truncate  ext-center mb-0\">\n\t\t\t\t\t\t\tViva Fan | El viajero inteligente\n\n\t\t\t\t\t\t</h4>\n\t\t\t\t\t</div>\n\n\t\t\t\t\t<div class=\"card-footer border-0 text-center bg-white pb-4\">\n\t\t\t\t\t\t<ul class=\"list-inline mb-0 mx-auto\">\n\t\t\t\t\t\t\t<li class=\"list-inline-item\"><span class=\"badge badge-secondary badge-pill\">VueJS</span>\n\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t<li class=\"list-inline-item\"><span class=\"badge badge-secondary badge-pill\">NodeJS</span>\n\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t<li class=\"list-inline-item\"><span class=\"badge badge-secondary badge-pill\">SASS</span>\n\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t<li class=\"list-inline-item\"><span class=\"badge badge-secondary badge-pill\">HTML5 /\n\t\t\t\t\t\t\t\t\tCSS3 </span></li>\n\t\t\t\t\t\t</ul>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<!--//card-->\n\t\t\t</div>\n\t\t\t<div class=\"col-12 col-lg-4 mt-4\">\n\t\t\t\t<div class=\"card rounded-0 border-0 shadow-sm mb-5 mb-lg-0\">\n\t\t\t\t\t<div class=\"card-img-container position-relative\">\n\t\t\t\t\t\t<img class=\"card-img-top rounded-0 h-90\" src=\"assets/images/projects/juntos_despegaremos.png\"\n\t\t\t\t\t\t\talt=\"Viva Contigo\">\n\t\t\t\t\t\t<div class=\"card-img-overlay overlay-logo text-center\">\n\t\t\t\t\t\t\t<div class=\"project-logo\"><img class=\"img-fluid\" style=\"width: 250px;\"\n\t\t\t\t\t\t\t\t\tsrc=\"assets/images/logos/logo-despegaremos.svg\"></div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<a class=\"card-img-overlay overlay-content text-left p-lg-4\"\n\t\t\t\t\t\t\t[href]=\"['https://www.vivaaerobus.com/es-mx/membresia/vivafan']\"\n\t\t\t\t\t\t\ttarget=\"_blank\">\n\t\t\t\t\t\t\t<p class=\"card-title font-weight-bold\">Conoce los negocios mexicanos</p>\n\t\t\t\t\t\t\t<p>\n\t\t\t\t\t\t\t\tConoce los negocios mexicanos que puedes visitar a lo largo del territorio Mexicano\n\t\t\t\t\t\t\t\tdesde ricos restaurantes hasta los mejores hoteles.\n\t\t\t\t\t\t\t</p>\n\n\t\t\t\t\t\t</a>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"card-body pb-0\">\n\t\t\t\t\t\t<h4 class=\"card-title text-truncate text-center mb-0\">\n\t\t\t\t\t\t\tJuntos Despegaremos\n\n\t\t\t\t\t\t</h4>\n\t\t\t\t\t</div>\n\n\t\t\t\t\t<div class=\"card-footer border-0 text-center bg-white pb-4\">\n\t\t\t\t\t\t<ul class=\"list-inline mb-0 mx-auto\">\n\t\t\t\t\t\t\t<li class=\"list-inline-item\"><span class=\"badge badge-secondary badge-pill\">VueJS</span>\n\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t<li class=\"list-inline-item\"><span class=\"badge badge-secondary badge-pill\">Jekyll</span>\n\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t<li class=\"list-inline-item\"><span class=\"badge badge-secondary badge-pill\">SASS</span>\n\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t<li class=\"list-inline-item\"><span class=\"badge badge-secondary badge-pill\">HTML5 /\n\t\t\t\t\t\t\t\t\tCSS3 </span></li>\n\t\t\t\t\t\t</ul>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<!--//card-->\n\t\t\t</div>\n\t\t\t<div class=\"col-12 col-lg-4 mt-4\">\n\t\t\t\t<div class=\"card rounded-0 border-0 shadow-sm mb-5 mb-lg-0\">\n\t\t\t\t\t<div class=\"card-img-container position-relative\">\n\t\t\t\t\t\t<img class=\"card-img-top rounded-0 h-90\" src=\"assets/images/projects/viva_contigo.png\"\n\t\t\t\t\t\t\talt=\"Viva Contigo\">\n\t\t\t\t\t\t<div class=\"card-img-overlay overlay-logo text-center\">\n\t\t\t\t\t\t\t<div class=\"project-logo\"><img class=\"img-fluid w-50\"\n\t\t\t\t\t\t\t\t\tsrc=\"assets/images/logos/viva_contigo_logo.svg\"></div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<a class=\"card-img-overlay overlay-content text-left p-lg-4\"\n\t\t\t\t\t\t\t[href]=\"['https://content.vivaaerobus.com/www/landings/covid19/prod/covid19_es.html']\"\n\t\t\t\t\t\t\ttarget=\"_blank\">\n\t\t\t\t\t\t\t<p class=\"card-title font-weight-bold\">Nuestras acciones ante el COVID-19</p>\n\t\t\t\t\t\t\t<p>\n\t\t\t\t\t\t\t\tConoce algunas de las acciones que estamos realizando ante la contingencia sanitaria.\n\n\t\t\t\t\t\t\t</p>\n\n\t\t\t\t\t\t</a>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"card-body pb-0\">\n\t\t\t\t\t\t<h4 class=\"card-title text-truncate text-center mb-0\">\n\t\t\t\t\t\t\tViva Contigo | Acciones COVID-19\n\t\t\t\t\t\t</h4>\n\t\t\t\t\t</div>\n\n\t\t\t\t\t<div class=\"card-footer border-0 text-center bg-white pb-4\">\n\t\t\t\t\t\t<ul class=\"list-inline mb-0 mx-auto\">\n\t\t\t\t\t\t\t<li class=\"list-inline-item\"><span class=\"badge badge-secondary badge-pill\">VueJS</span>\n\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t<li class=\"list-inline-item\"><span class=\"badge badge-secondary badge-pill\">Jekyll</span>\n\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t<li class=\"list-inline-item\"><span class=\"badge badge-secondary badge-pill\">SASS</span>\n\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t<li class=\"list-inline-item\"><span class=\"badge badge-secondary badge-pill\">HTML5 /\n\t\t\t\t\t\t\t\t\tCSS3 </span></li>\n\t\t\t\t\t\t</ul>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<!--//card-->\n\t\t\t</div>\n\t\t\t<div class=\"col-12 col-lg-4 mt-4\">\n\t\t\t\t<div class=\"card rounded-0 border-0 shadow-sm mb-5 mb-lg-0\">\n\t\t\t\t\t<div class=\"card-img-container position-relative\">\n\t\t\t\t\t\t<img class=\"card-img-top rounded-0 h-90\" src=\"assets/images/projects/project-1-thumb.jpg\"\n\t\t\t\t\t\t\talt=\"S&P México\">\n\t\t\t\t\t\t<div class=\"card-img-overlay overlay-logo text-center\">\n\t\t\t\t\t\t\t<div class=\"project-logo\"><img class=\"img-fluid w-50\"\n\t\t\t\t\t\t\t\t\tsrc=\"assets/images/logos/logo_S&P.png\"></div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<a class=\"card-img-overlay overlay-content text-left p-lg-4\" [href]=\"['https://solerpalau.mx/']\"\n\t\t\t\t\t\t\ttarget=\"_blank\">\n\t\t\t\t\t\t\t<h5 class=\"card-title font-weight-bold\">Página Oficial</h5>\n\n\t\t\t\t\t\t</a>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"card-body pb-0\">\n\t\t\t\t\t\t<h4 class=\"card-title text-truncate text-center mb-0\">\n\t\t\t\t\t\t\tSoler & Palau México\n\t\t\t\t\t\t</h4>\n\t\t\t\t\t</div>\n\n\t\t\t\t\t<div class=\"card-footer border-0 text-center bg-white pb-4\">\n\t\t\t\t\t\t<ul class=\"list-inline mb-0 mx-auto\">\n\t\t\t\t\t\t\t<li class=\"list-inline-item\"><span class=\"badge badge-secondary badge-pill\">PHP</span></li>\n\t\t\t\t\t\t\t<li class=\"list-inline-item\"><span class=\"badge badge-secondary badge-pill\">jQuery</span>\n\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t<li class=\"list-inline-item\"><span class=\"badge badge-secondary badge-pill\">Oracle</span>\n\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t<li class=\"list-inline-item\"><span class=\"badge badge-secondary badge-pill\">HTML /\n\t\t\t\t\t\t\t\t\tCSS</span></li>\n\t\t\t\t\t\t</ul>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<!--//card-->\n\t\t\t</div>\n\t\t\t<div class=\"col-12 col-lg-4 mt-4\">\n\t\t\t\t<div class=\"card rounded-0 border-0 shadow-sm mb-5 mb-lg-0\">\n\t\t\t\t\t<div class=\"card-img-container position-relative\">\n\t\t\t\t\t\t<img class=\"card-img-top rounded-0\" src=\"assets/images/projects/project-2-thumb.jpg\" alt=\"\">\n\t\t\t\t\t\t<div class=\"card-img-overlay overlay-logo text-center\">\n\t\t\t\t\t\t\t<div class=\"project-logo\"><img class=\"img-fluid w-50\"\n\t\t\t\t\t\t\t\t\tsrc=\"assets/images/logos/logo_ferrari.png\"></div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<a class=\"card-img-overlay overlay-content text-left p-lg-4\"\n\t\t\t\t\t\t\t[href]=\"['https://www.ferrariventilatori.mx/']\" target=\"_blank\">\n\t\t\t\t\t\t\t<h5 class=\"card-title font-weight-bold\">Página Oficial</h5>\n\t\t\t\t\t\t\t<!-- <p class=\"card-text\">Project summary goes here. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque vel sapien quis nulla dictum euismod...</p> -->\n\t\t\t\t\t\t</a>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"card-body pb-0\">\n\t\t\t\t\t\t<h4 class=\"card-title text-truncate text-center mb-0\">\n\t\t\t\t\t\t\tFerrari Ventilatori México\n\t\t\t\t\t\t</h4>\n\t\t\t\t\t</div>\n\n\t\t\t\t\t<div class=\"card-footer border-0 text-center bg-white pb-4\">\n\t\t\t\t\t\t<ul class=\"list-inline mb-0 mx-auto\">\n\t\t\t\t\t\t\t<li class=\"list-inline-item\"><span class=\"badge badge-secondary badge-pill\">PHP</span></li>\n\t\t\t\t\t\t\t<li class=\"list-inline-item\"><span class=\"badge badge-secondary badge-pill\">jQuery</span>\n\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t<li class=\"list-inline-item\"><span class=\"badge badge-secondary badge-pill\">MySQL</span>\n\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t<li class=\"list-inline-item\"><span class=\"badge badge-secondary badge-pill\">HTML /\n\t\t\t\t\t\t\t\t\tCSS</span></li>\n\t\t\t\t\t\t</ul>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<!--//card-->\n\t\t\t</div>\n\t\t\t<div class=\"col-12 col-lg-4 mt-4\">\n\t\t\t\t<div class=\"card rounded-0 border-0 shadow-sm mb-5 mb-lg-0\">\n\t\t\t\t\t<div class=\"card-img-container position-relative\">\n\t\t\t\t\t\t<img class=\"card-img-top rounded-0\" src=\"assets/images/projects/project-3-thumb.jpg\" alt=\"\">\n\t\t\t\t\t\t<div class=\"card-img-overlay overlay-logo text-center\">\n\t\t\t\t\t\t\t<div class=\"project-logo\"><img class=\"img-fluid w-50\"\n\t\t\t\t\t\t\t\t\tsrc=\"assets/images/logos/logo_rake.png\"></div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<a class=\"card-img-overlay overlay-content text-left p-lg-4\" [href]=\"['https://rake.mx/']\"\n\t\t\t\t\t\t\ttarget=\"_blank\">\n\t\t\t\t\t\t\t<h5 class=\"card-title font-weight-bold\">Página Oficial</h5>\n\t\t\t\t\t\t</a>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"card-body pb-0\">\n\t\t\t\t\t\t<h4 class=\"card-title text-truncate text-center mb-0\">\n\t\t\t\t\t\t\tAgro Insumos Rake\n\t\t\t\t\t\t</h4>\n\t\t\t\t\t</div>\n\n\t\t\t\t\t<div class=\"card-footer border-0 text-center bg-white pb-4\">\n\t\t\t\t\t\t<ul class=\"list-inline mb-0 mx-auto\">\n\t\t\t\t\t\t\t<li class=\"list-inline-item\"><span class=\"badge badge-secondary badge-pill\">Vue js</span>\n\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t<li class=\"list-inline-item\"><span class=\"badge badge-secondary badge-pill\">FireBase</span>\n\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t<li class=\"list-inline-item\"><span class=\"badge badge-secondary badge-pill\">HTML5 /\n\t\t\t\t\t\t\t\t\tCSS</span></li>\n\t\t\t\t\t\t\t<li class=\"list-inline-item\"><span class=\"badge badge-secondary badge-pill\">Bootstrap</span>\n\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t</ul>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<!--//card-->\n\t\t\t</div>\n\n\t\t</div>\n\t\t<!--//row-->\n\t\t<div class=\"text-center\">\n\t\t\t<!-- <a class=\"btn btn-primary\" >Ver todos los proyectos</a> -->\n\t\t</div>\n\t</div>\n\t<!--///container-->\n\n</section>"
...
module.exports = __webpack_require__(/*! /home/manuelperezg/Documentos/Angular/portafolio/src/main.ts */"./src/main.ts");
